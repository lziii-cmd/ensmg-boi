...
import { AlertTriangle, Lightbulb, Users, BarChart2, TrendingUp } from "lucide-react";
...
export default function DashboardPage() {
  ...
  const filteredNavCards = NAV_CARDS.filter((c) => !c.adminOnly || isAdmin);
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        {filteredNavCards.map(({ to, icon: Icon, label, iconClass, bg }) => (
          <Link key={to} to={to}>
